  ...
  got_modified_reference_path_(false)
{
  ...
  eb_planner_ptr_.reset(new QPPlanner());
  ...
  markers_pub_ = nh_.advertise<visualization_msgs::MarkerArray>("eb_planner_debug_markes", 1, true);
...
void QPPlannerROS::timerCallback(const ros::TimerEvent &e)
{
  ...
  { 
    ...
    // visualize compensted points at eb_planner
